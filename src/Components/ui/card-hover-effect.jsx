      ...
      {items.map((item, idx) => (
        ...
        >
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute inset-0 h-full w-full bg-neutral-200 dark:bg-gradient-to-r from-indigo-500 from-10% via-purple-500 via-30% to-pink-500 to-90% block rounded-3xl"
